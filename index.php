						...
						<div id = "form">
							...
							<?php
								...
								while($row = mysql_fetch_assoc($result)){
									echo "<b>Floor:</b> ".$row['floor']."<br><b>Work:</b> ".$row['work']."<br><b>Employee type:</b> ".$row['man_d']."<br><b>Material:</b> ".$row['mat_n']."<br><b>End date:</b> ".$row['end_d']."<br><b>Manpower:</b> ".$row['man_q']."<br><b>Material Quantity:</b> ".$row['mat_q']."<br><b>Funds:</b> Rs.".$row['funds'];
								}
							?>
						</div>
					</div><!-- /scroller-inner -->
